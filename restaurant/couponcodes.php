				...
				<div class="cl3 left col30" style="margin-right: 10px;">
					...
					<div class="itm"> 
						<div class="cardnm left col60"><strong>Code:</strong> <?php echo $vaaal['RestaurantCoupon']['coupon_code']; ?>
    						<br> 
    						<strong>Expiry:</strong> <?php echo $vaaal['RestaurantCoupon']['expire_date']; ?> <br>
    						<strong>Limit:</strong> <?php echo $vaaal['RestaurantCoupon']['limit_users']; ?> <br>
						...
						<div style="color: red;text-align: right;font-size: 13px;">
						    <a href="dashboard.php?p=couponcodes&del=cc&id=<?php echo $vaaal['RestaurantCoupon']['id']; ?>">
