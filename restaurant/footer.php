...
<footer class="sitefooter">
    <div class="wdth">
        <div class="copyright">
            All trademarks are properties of their respective owners. &copy; 2020 - Weydrop. All rights reserved.
        </div> <?php //copyright ?>
    </div>
</footer>
...
if (isset($_GET['action'])) {
    if ($_GET['action'] == "error") {
        if($_GET['errorcode'])
      {
        echo "<div class='notification'><div class='wdth'><div class='alert alert-error'>Already Cancelled this Order.</div></div></div>";
      }else{
