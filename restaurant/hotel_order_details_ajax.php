...
if( isset($_SESSION[PRE_FIX.'restaurant_id']) && isset($_GET['uid']) && isset($_GET['orderID']))
{ 
			...
			if($json_data['code'] !== 200){
				...
				foreach( $json_data['msg'] as $str => $val ) {
					...
					<div class="orderinformation">
						...
						<h1 align="center" style="margin: 0px 0 20px 0;">Order #<?php echo $val['Order']['order_number']; ?></h1>
						<div class="sect">
						...
						<?php  if($val['Order']['available_status'] ==1 && $val['Order']['booking_day_time'] != ""){ ?>
	
							<div class="sect">

								<h3>Booking Delivery Details</h3>

								<p><i class="fa fa-calendar-o"></i> <?php echo date('d-m-Y', strtotime($val['Order']['booking_date'])); ?></p>
								<p><i class="fa fa-calendar"></i> <?php echo strtoupper($val['Order']['booking_day']); ?></p>

								<p><i class="fa  fa-clock-o"></i> <?php echo $val['Order']['booking_day_time']; ?></p>
...
if( isset($_SESSION[PRE_FIX.'restaurant_id']) && isset($_GET['orderID_notificaiton']))
{
	...
	$pastCount=$_SESSION[PRE_FIX.'orderCount'];
	
	$_SESSION[PRE_FIX.'orderCount'] = $orderCount;
