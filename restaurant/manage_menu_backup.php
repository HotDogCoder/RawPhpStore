...
if( isset($_SESSION[PRE_FIX.'restaurant_id']) && $_SESSION[PRE_FIX.'user_type'] == "hotel" ){ ?>
...
if(isset($_GET['add'])) {
	if($_GET['add']=="menu") {
		...
		//$user_id = "5";
		//$restaurant_id = $_SESSION[PRE_FIX.'restaurant_id'];
	...
	if($_GET['add']=="menuitem") {
        ...
        //$user_id = htmlspecialchars($_SESSION[PRE_FIX.'restaurant_id'], ENT_QUOTES);
