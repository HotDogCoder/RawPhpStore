...
<html xmlns="http://www.w3.org/1999/xhtml" <?php if(isset($_GET['city'])){echo "style=\"height: 100%; min-height: 100vh!important; margin: 0; padding: 0\"";} ?>>
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script>		
		...
		function setUrlAddress(latitude, longitude){
    		...
    		.then((data) => {
    			city = getCity(data);
                var url = "https://www.weydrop.com/sa-en/search.php?address="+city+",+Saudi Arabia"+"&lat="+latitude+"&lng="+longitude+"&city="+city;
        ...
        ?>
            <div id="mySidenav" class="sidenav">
                <ul>
                    ...
                    <ul class="sub-menu">
                        <li><a href="dashboard.php?p=order">My Orders <span class="blok">View order & their details</span></a></li>
                        <li><a href="dashboard.php?p=account">My Account <span class="blok">View or edit your account details</span></a></li>
                        <li><a href="dashboard.php?p=changepassword">Change Password <span class="blok">Change your account password</span></a></li>
                        <li><a href="dashboard.php?p=payment">Payment Methods <span class="blok">View or edit your payment methods</span></a></li>
    ...
    { 
        ?>
            <div id="mySidenav" class="sidenav">
                <ul>
                    <li>
                        <span style="color: #38215C; font-size: 17px; font-family: Tajawal;" onClick="popup('login')">عربى</span>
                        <span style="color: #38215C" onClick="popup('login')">/ Login</span>
                    </li>
                </ul>
            </div>
        <?php 
...
?>
<header class="siteheader" style="background: <?php if(isset($_GET["id"]) || isset($_GET["city"])){echo "#F4C951";} else {echo "white";}?>; background-image: url(assets/img/new/<?php if(isset($_GET["id"]) || isset($_GET["city"])){echo "topbar_white.png";} else {echo "topbar_yellow.png";}?>); background-size: contain; background-repeat:no-repeat;">
    <div class="wdth" style="margin-left: 2%;">
           ...
           <span class="menu-icon opensidemenu" id="opensidemenu" onClick="openNav()">
            ...
            <ul class="nav-menu dnav">
                <?php 
                    ...
                    { 
                        ...
                        ?>                            
                            <li class="lastmenu"><a><span class="myacc" style="color: #38215C; display:none;">Account</span>
                                ...
                                <ul class="submenu">
                                    <li <?php echo $order;?>><a href="dashboard.php?p=order">My Orders <span class="blok">View order & their details</span></a></li>
                                    <li <?php echo $account;?>><a href="dashboard.php?p=account">My Account <span class="blok">View or edit your account details</span></a></li>
                                    <li <?php echo $changepassword;?>><a href="dashboard.php?p=changepassword">Change Password <span class="blok">Change your account password</span></a></li>
                                    
                                    <li <?php echo $payment;?>><a href="dashboard.php?p=payment">Payment Methods <span class="blok">View or edit your payment methods</span></a></li>
                                    <li class="logout"><a href="index.php?log=out">Log Out</a></li>
                                </ul>
                            </li>
                        <?php 
                    ...
                    { 
                        ?>
                        <li style="position: absolute; top: 35%; right: 8%; width: 100px;">
                            <span style="color: #38215C; cursor: pointer; font-size: 17px; font-family: Tajawal;" onClick="location.replace('https://www.weydrop.com/sa-ar/')">عربي</span>
                            <span style="color: #38215C; cursor: pointer; font-size: 17px; font-family: Tajawal;" onClick="popup('login')">/ Login</span>
                        </li>
                        <?php 
                    } 
                ?>
        ...
        <?php
         if (isset($_SESSION['id'])) 
                { ?>
        <span class="right" style="margin: 0.3% 2% 0 0; color: #38215C; cursor: pointer; font-size: 17px; font-family: Tajawal;" onClick="location.replace('https://www.weydrop.com/sa-ar/')">عربي</span>
            <?php } ?>
        <div class="clear"></div>
    </div>
</header>
