<?php require_once("header.php");?>
    <div class="text-center landingimage bgimage searcharea">
        <div class="inner">
            <div class="wdth">
                <h1><?php echo SLIDER_AREA_H1_TITLE; ?></h1>
                <h2><?php echo SLIDER_AREA_H2_TITLE; ?></h2>
				<div style="background-color: transparent; text-align: center!important;">
					...
					<!--	<label for="orderNow" style="background: #E86942; border-radius: 10px; font-weight: bold;">Order Now</label>-->
					<!--</div>-->
					<!--</a>-->
                        <?php
                        $address="Khobar%2C+Saudi Arabia&lat";
                        $API_KEY = "https://www.googleapis.com/geolocation/v1/geolocate?key=AIzaSyCZja2jZkxh8iRN3cMN30bmIytKfrMnJfE";
                        ...
                        <?php 
                        echo '<a href="search.php?address=Khobar%2C+Saudi Arabia&lat=26.36704100&lng=50.17762600&city=Khobar">
                            <div class="radiobtn" style="width: 230px; margin-left: auto; margin-right: auto; margin-top: 3%">
                                <label for="orderNow" style="background: #E86942; border-radius: 10px; font-weight: bold;">Order Now</label>
                            </div>
                        </a>'
                        ...
                        echo "<a href=\"\">
                            <div class=\"radiobtn\" style=\"width: 230px; margin-left: auto; margin-right: auto; margin-top: 3%\">
                                <label for=\"orderNow\" style=\"background: #E86942; border-radius: 10px; font-weight: bold;\">{$address}</label>
                            </div>
                        </a>"
                        ?>
    ...
    <div class="section howitworks textcenter sec1" style=" padding: 4.5%; padding-top: 9%;">
        <div class="wdth">
            <h2 class="title" style="padding-bottom: 3%; color: #38215C; font-size: 50px"><? echo HOW_IT_WORKS_TITLE; ?></h2>
            <ul>
                <li>
                    <div class="iconwork">
                        <span class="icon2"></span>
                    </div>
                    <h3 style="color: #38215C"><?php echo HOW_IT_WORKS_SUB_TITLE; ?></h3>
                    <p style="color: #38215C"><?php echo HOW_IT_WORKS_DESCRIPTION; ?></p>
                </li>
                <li>
                    <div class="iconwork">
                        <span class="icon3"></span>
                    </div>
                    <h3 style="color: #38215C"><?php echo HOW_IT_WORKS_SUB_TITLE_2; ?></h3>
                    <p style="color: #38215C"><?php echo HOW_IT_WORKS_DESCRIPTION_2; ?></p>
                </li>
                <li>
                    <div class="iconwork">
                        <span class="icon4"></span>
                    </div>
                    <h3 style="color: #38215C"><?php echo HOW_IT_WORKS_SUB_TITLE_3; ?></h3>
                    <p style="color: #38215C"><?php echo HOW_IT_WORKS_DESCRIPTION_3; ?></p>
    ...
    <div class="section workwithus textcenter" style="padding: 0%;">
        <div class="wdth">
            <h2 class="title" style="color: #38215C; font-size: 50px">Join Us</h2>
            <h2 class="title" style="color: #38215C; font-size: 50px"><?php echo WORK_WITH_US_TITLE; ?></h2>
            <ul>
                <li style="background: transparent;">
                    <div class="bgimage workwithus" style="margin-bottom: 9%"></div>
                    <h2 style="margin-bottom: 5%; color: #38215C; font-size: 30px"><?php echo WORK_WITH_US_SUB_TITLE; ?></h2>
                    <p style="color: #38215C"><?php echo WORK_WITH_US_DESCRIPTION; ?>
                        <br>
                        <br>
                        <br>
                        <br>
                ...
                <li style="background: transparent;">
                    ...
                    <h2 style="margin-bottom: 5%; color: #38215C; font-size: 30px"><?php echo WORK_WITH_US_SUB_TITLE_2; ?></h2>
                    <p style="color: #38215C">
    ...
    <div class="mobrow bgimage appBanner" style="background: transparent; padding-top: 18%; padding-bottom: 10%">
        <div class="wdth">
            ...
            <div class="col60 section" style="">
                <h2 class="title" style="color: #38215C; font-size: 55px;"><?php echo MOBILE_APP_TITLE; ?></h2>
                <div style="margin-left: 8%; text-align: center;">
                <p class="appDescription" style="width: 350px; color: #38215C; font-size: 15px; padding-bottom: 5%"><?php echo MOBILE_APP_DESCRIPTION; ?></p>
