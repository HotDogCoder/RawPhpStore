...
<div>
     <div class="login-page login-form-fall" style="background-image: url(img/main-banner.jpg); background-position: center; background-size: cover; background-repeat: no-repeat; min-height: calc(100vh - 70px);">

        <div class="login-container" style="background-color: transparent;">
            <div class="login-header login-caret" style="background-color: transparent;">
