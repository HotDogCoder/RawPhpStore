                                                    ...
                                                    <ul class="more-menu-items" tabindex="-1" role="menu" aria-labelledby="more-btn" aria-hidden="true">
                                                       ...
                                                       <a href="?p=editResturent&id=<?php echo $single_user['Restaurant']['id']; ?>">
                                                        ...
                                                        if ($single_user['Restaurant']['single_restaurant'] == "0") {
                                                            ?>
                                                            <a href="?p=restaurants&action=SingleRestaurant&id=<?php echo $single_user['Restaurant']['id']; ?>&single_restaurant=1" style="display:non1e;">
                                                                <li class="more-menu-item" role="presentation">
                                                                    <button type="button" class="more-menu-btn" role="menuitem">Select Spicy Single</button>
                                                                </li>
                                                            </a>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <a href="?p=restaurants&action=SingleRestaurant&id=<?php echo $single_user['Restaurant']['id']; ?>&single_restaurant=0" style="display:non1e;">
                                                                <li class="more-menu-item" role="presentation">
                                                                    <button type="button" class="more-menu-btn" role="menuitem" style="color:red;">Un-Select Spicy Single </button>
                                                                </li>
                                                            </a>
                                                            <?php
                                                        }
