...
if( isset($_SESSION[PRE_FIX.'sessionTokon']))
{
        ...
        if(@$_GET['AssignToRider']=="ok")
    	{
    		...
    		$assigner_user_id = $_SESSION[PRE_FIX.'id'];
    		...
    		$headers = array(
    		  ...
    		  // die();
    		   ...
    		   {
    		    	echo "<script>window.location='dashboard.php?p=manageOrders&status=error'</script>";
    		   }
                    ...
                    <div class="qr-content-area">
                        <div class="qr-row">
                            <div class="qr-el">
                                ...
                                <script src="https://maps.google.com/maps/api/js?key=<?php echo Google_Map_Key;?>"></script>
                        		<!--<script src="../js/locationpicker.jquery.js"></script>-->
                         		<div id="map" style="height: 55%; width: 100%; float: left;margin-bottom: 30px !important;" class="qr-el qr-el-1"></div>
                                    ...
                                    // Cretes the map
                                     ...
                                     function initialize() 
                                     {
        							         ...
        							         <?php  
        					                    ...
        					                    $ch = curl_init($baseurl . 'showRiders');
                                                curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
                                                curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'POST');
                                                curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($data));
                                                curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
                            						...
                            						//print_r($json_data);
                            	                       ?>
                            	                        <tr>
                            	                            ...
                            	                            <td><a href="?p=assignRider&AssignToRider=ok&rider_user_id=<?php echo $data['UserInfo']['user_id']; ?>&assigner_user_id=<?php echo @$_SESSION[PRE_FIX.'id']; ?>&order_id=<?php echo $_GET['orderID']; ?>" style='background:#E77830; margin-top:5px; color:white; text-decoration: none; width:100%; padding:5px 20px; ' >Assign Order</a></td>
                            	                        </tr>
                            	                      <?php
                            	                }
