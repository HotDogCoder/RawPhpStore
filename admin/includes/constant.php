...
if (isset($_GET['p']) == "login") {
      ...
      if ($json_data['code'] == 201) {
            ...
            $_SESSION[PRE_FIX.'id'] = $data[0]['id'];
            $_SESSION[PRE_FIX.'role'] = $data[0]['role'];
            
            
            if ($_SESSION[PRE_FIX.'role'] == "user") {
                  $_SESSION[PRE_FIX.'email'] = $data[0]['email'];
                  $_SESSION[PRE_FIX.'name']= $data[0]['first_name'] . " " .$data[0]['last_name'];
                  
                  echo "<script>window.location='ShowAttendance.php'</script>";
            }
            elseif ($_SESSION[PRE_FIX.'role'] == "admin") {
