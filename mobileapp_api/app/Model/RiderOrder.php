...
class RiderOrder extends AppModel
{
    ...
    public function getRiderOrders($rider_user_id)
    {
    ...
    public function getRiderUnpaidOrders($rider_user_id)
    {
        ...
        return $this->find('all', array(
            ...
            'conditions' => array(
                ...
                'RiderOrder.rider_user_id' => $rider_user_id,
                'RiderOrder.rider_transaction_id' => 0,
    ...
    public function getRiderUnPaidEarnings($rider_id)
    {
        ...
        return $this->find('count', array(
            ...
            'conditions' => array(
                ...
                'RiderOrder.rider_user_id' => $rider_id
    ...
    public function saveRiderTransactionID($rider_transaction_id,$rider_id)
    {

        return $this->updateAll(array(

            'RiderOrder.rider_transaction_id'=>$rider_transaction_id
    ...
    public function getRiderEarnings()
    {
        ...
        return $this->find('all', array(
            ...
            'group'=>array('RiderOrder.rider_user_id'),

            'fields' => array(

                'count(RiderOrder.id)   AS total_orders','Rider.*'),
    ...
    public function getRiderEarningsAgainstStartAndEndDate($start_date,$end_date)
    {
    ...
    public function checkIfOrderHasBeenAssignedToRiderOrNot($order_id,$rider_user_id)
    {
        ...
        return $this->find('count', array(
            ...
            'conditions' => array(
                ...
                'Rider.online' => 1,
                'RiderOrder.accept_reject_status'=> array(0, 2)
