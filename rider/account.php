<?php if( isset($_SESSION[PRE_FIX.'rider_id']) && $_SESSION[PRE_FIX.'user_type'] == "rider" ){ ?>
	...
	<div class="left col40">
			...
			if( isset($_GET['upd']) ) {
				...
				if( !empty($first_name) && !empty($last_name) ) {
					...
					if($json_data['code'] !== 200){
						...
						$_SESSION[PRE_FIX.'first_name'] = $first_name;
						$_SESSION[PRE_FIX.'last_name'] = $last_name;
						$_SESSION[PRE_FIX.'name'] = $first_name." ".$last_name;
		...
		<div class="form">
			<form action="dashboard.php?p=account&upd=ok" id="accoutinfo" method="post">
				<p><input type="text" placeholder="First Name" name="fname" id="fname" value="<?php echo $_SESSION[PRE_FIX.'first_name']; ?>"></p>
				<p><input type="text" placeholder="Last Name" name="lname" id="lname" value="<?php echo $_SESSION[PRE_FIX.'last_name']; ?>"></p>
				<p><input type="text" placeholder="Phone Number" name="num" id="num" value="<?php echo $_SESSION[PRE_FIX.'phone']; ?>" readonly></p>
				<p><input type="email" placeholder="Email Address" name="eml" id="eml" value="<?php echo $_SESSION[PRE_FIX.'email']; ?>" readonly></p>
