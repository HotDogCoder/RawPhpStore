	...
	else 
	{
		...
		foreach( $json_data['msg'] as $str => $val ) {
			...
			<tr>
				...
				<td><?php echo "<span class='blok' style='margin:0; color:green; font-weight:500;'>".$val['Order']['price'].' '.$currency."</span>"; ?></td>
				<td><?php echo "<span class='blok' style='margin:0; color:green; font-weight:500;'>".$val['Order']['rider_tip'].' '.$currency."</span>"; ?></td>
					...
					<div class="rate">
						<?php
							if($val['RiderRating']['star']!="")
							{
								...
								{
									?>
										<i class="fa fa-star" style="color:#E86942;"></i>
									<?php
								}
								if($star>0)
								{
									...
									{
										?>
											<i class="fa fa-star-o" style="color:#E86942;"></i>
										<?php
									}
								}
							}
				...
				<?php
				    ...
				    {
				?>
				    <td><?php echo date('d-m-Y',strtotime($val['Order']['booking_date'])); ?><br/>
				    <?php echo strtoupper($val['Order']['booking_day']); ?><br/>
