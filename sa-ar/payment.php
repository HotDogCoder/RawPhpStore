        ...
        <div class="form">
            <form action="dashboard.php?p=payment&action=add_payment" id="paymethd" method="post">
                <p>
                    ...
                    <label alt="إسم صاحب البطاقة" placeholder="إسم صاحب البطاقة"></label>
                </p>
                <p>
                    <input type="text" name="cardnum" id="cardnum" data-inputmask="'mask': '9999 9999 9999 9999'" maxlength="19" required>
                    <label alt="رقم البطاقة" placeholder="رقم البطاقة"></label>
                </p>
                ...
                <div class="clear"></div>
                <p>
                    <input type="submit" value="إضافة طريقة دفع">
                </p>
            </form>
        </div>
    </div>
